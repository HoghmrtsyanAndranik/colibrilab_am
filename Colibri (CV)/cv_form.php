		...
		<div class = "container">
			...
			<div class = "all-body-first">
				<div class = "body-nn" style = "flex-direction: column;">
					<div class = "line-first handle l-one " style="display: none;" >
						<div class = "gluing">
							<div class = "flex">
				...
				<div class = "line-first handle l-sec" style="display: none;">
					<div class = "gluing">
						<div class = "flex">
							<p class = "phplaravel-sec">Laravel</p>
							<div class ="percent-sec">70%</div>
						</div>
						<div class = "flex-sec fl" style="left: 166px;top:0px;">
							<i class="fa fa-times-circle x" aria-hidden="true"style="margin-left: 40px;"></i>
							<i class="fa fa-pencil pen-one" aria-hidden="true" style="display: none;"></i>
			...
			<div class = "line-first handle l-th" style="display: none;">
				<div class = "gluing">
					<div class = "flex">
						<p class = "phplaravel-th">Javascript</p>
						<div class ="percent-th">50%</div>
					</div>
					<div class = "flex-sec fl" style="left: 166px;top:0px;">
						<i class="fa fa-times-circle x" aria-hidden="true" style="margin-left: 40px;"></i>
						<i class="fa fa-pencil pen-one" aria-hidden="true" style="display: none;"></i>
