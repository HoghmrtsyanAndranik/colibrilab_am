	...
	<table width="100%"  style="background-image: url(https://i.imgur.com/e6f8Fq3.png);background-size:cover;background-repeat: no-repeat;">
		<tr>
			...
			<tr>
					...
					<td align="center">
					<h1 style="font-family: sans-serif;font-weight: bold;font-size: 40px;color: #272727">Շնորհակալություն !<br>
					Գրանցումը հաջողությամբ կատարվել է</h1>
				</td>
				
			</tr>
			<tr>
				<td align="center">
					<img src="call_back.svg" style="display: block;" width="100">
				</td>
			</tr>
			<tr>
				<td align="center">
					<p style="font-family: sans-serif;font-weight: bold;font-size: 23px;color: #272727">Մեր աշխատակիցը հնարավորինս շուտ կապ կհաստատի Ձեզ հետ</p>
				</td>
			</tr>
			<tr>
				<td align="center"> 
					<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center" style="width: 100%;max-width: 1140px;border:1px solid #A6A6A6;border-radius: 10px;Margin-top: 20px;padding: 20px 0" bgcolor="#FFFFFF">
						<tr>
							...
							<td rowspan="2" style="color:#272727;font:bold 18px sans-serif;">
								<table align="center" >
									<tr>
										<td> <img src="call-phone.svg" style="Margin-right: 10px;display: block;" width="20"></td>
										<td><p style="Margin: 5px">+374 096 06 41 70</p></td>
									</tr>
									<tr>
										<td> <img src="mail_2.svg" style="Margin-right: 10px;display: block;" width="20"></td>
										<td><p style="Margin: 5px">Armenhakobyan@gmail.com</p></td>
									</tr>
								</table>
							</td>
						</tr> 
							<tr  align="center">
							<td align="left"><p  style="color:#272727;font:bold 20px sans-serif">Հակոբյան Արմեն</p></td>
						...
						<tr>
							<td>
								<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center" style="width: 100%;max-width: 900px;">
									<tr>
										<td align="leftmargin"><h1 style="color: #31597B;font:bold 25px sans-serif">Դասընթացի մասին`</h1> </td>
									...
									<tr>
										<td>
											<p style="color: #707479;font:18px sans-serif">
												Html, CSS,Responsive design, Bootstrap,JavaScript, OOP, jQuery,React.js 
											</p>
										</td>
									</tr>
									<tr>
										<td>
											<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center" style="width: 100%;max-width: 900px;">
												<tr style="font: 20px sans-serif">
													...
													<td><p style="Margin:6px">3 ամիս</p>
														<p style="Margin:6px">3 դաս շաբաթական</p>
														<p style="Margin:6px">2 ժամ տևողությամբ</p>
													</td>
												</tr>
											</table>
										</td>
									...
									<tr>
										<td>
											<table  border="0" cellpadding="0" cellspacing="0" width="100%" align="center" style="width: 100%;max-width: 900px;">
												<tr>
													<td>
														<h1 style="color: #31597B;font:bold 25px sans-serif">Մեկ ամսվա գումարը՝</h1>
													</td>
													<td><h1 style="font:bold 25px sans-serif">30 000 դրամ</h1></td>
												</tr>
											</table>
										</td>
									</tr>
					...
					<tr>
						<td>
							<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center" style="width: 100%;max-width: 900px;">
								<tr>
									<td>
										<p style="color: #707479;font:18px sans-serif">Խնդրում ենք չպատասխանել այս նամակին։ Մենք կկապվենք Ձեզ հետ:</p>
									</td>
								</tr>
								<tr>
									<td>
										<p style="color: #707479;font:18px sans-serif">Եթե ունեք հարցեր խնդրում ենք կապ հաստատել մեզ հետ մեր <a href="#" style="color: #4F8BFF">վեբ կայքի</a> միջոցով կամ զանգահարել հետևյալ
									հեռախոսահամարներով՝ +374 91 23-43-67, +374 77 51-46-31 ։</p>
									</td>
								</tr>
								<tr>
									<td align="center">
										<p style="color: #4F8BFF;font:18px sans-serif">www.colibrilab.com
										</p>
									</td>
								</tr>
							</table>
