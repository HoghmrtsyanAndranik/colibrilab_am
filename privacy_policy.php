...
?>
    ...
    <div class="container" id="priv" style="margin-top: 130px">
        ...
        <p style="padding-bottom: 100px">Եթե դուք ունեք այլ հարցեր կամ կասկածներ գաղտնիության քաղաքականության վերաբերյալ, խնդրում ենք ուղարկել մեզ նամակ info@colibrilab.am էլ. հասցեին:</p>
    </div>
