...
?>
    ...
    <div class="container" id="priv" style="margin-top: 130px">
        ...
        <p>Ձեր տվյալների գաղտնիությունն ու անվտանգությունը պաշտպանելու համար, մենք ստուգում ենք ձեր ինքնությունը՝ նախքան մուտքի թույլտվություն  և ուղղումներ կատարելու հնարավուրություն տալը: Եթե ցանկանում եք մուտք գործել և խմբագրել ձեր անձնական տվյալները, գրեք մեր էլ. փոստին ՝ info@aist.global:</p>
